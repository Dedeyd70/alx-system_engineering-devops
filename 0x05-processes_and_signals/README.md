...
how to handle process ID's and signals in Bash
with `ps`, `pgrep`, `kill`, `pkill`, `exit`, and `trap`.
In this project all our bash script must be executable and must pass the shell check without any error
